...
variable "ep_private_key_path" { default = "/home/<your user>/.ssh/<public key>" }
variable "partner_public_key_path" { default = "/home/<your user>/.ssh/<public key>" }
variable "partner_private_key_path" { default = "/home/<your user>/.ssh/<public key>" }
...
variable "aws_region" { default = "<location of amazon cloud, e.g. sa-east-1>" }
variable "ukc_rpm" { default = "<Name of UKC package, e.g. ekm-2.0.1905.36686-RHES.x86_64.rpm>" }
